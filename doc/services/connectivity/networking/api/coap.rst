...
- :rfc:`9668` - Using EDHOC with the Constrained Application Protocol (CoAP) and OSCORE
...
The library additionally provides server-side support for Ephemeral
Diffie-Hellman Over COSE (EDHOC) as specified in :rfc:`9528` and :rfc:`9668`.
See :ref:`coap_edhoc_interface` for more information.
